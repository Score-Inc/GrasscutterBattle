...
public class MonsterData extends GameResource {
    ...
    public void setAttackBase(float attackBase) {
		baseAttack = attackBase;
	}

	public void setDefenseBase(float defenseBase) {
		baseDefense = defenseBase;
	}

	public void setFireSubHurt(float FireSubHurt) {
		fireSubHurt = FireSubHurt;
	}

	public void setElecSubHurt(float ElecSubHurt) {
		elecSubHurt = ElecSubHurt;
	}

	public void setGrassSubHurt(float GrassSubHurt) {
		grassSubHurt = GrassSubHurt;
	}

	public void setWaterSubHurt(float WaterSubHurt) {
		waterSubHurt = WaterSubHurt;
	}

	public void setWindSubHurt(float WindSubHurt) {
		windSubHurt = WindSubHurt;
	}

	public void setRockSubHurt(float RockSubHurt) {
		rockSubHurt = RockSubHurt;
	}

	public void setIceSubHurt(float IceSubHurt) {
		iceSubHurt = IceSubHurt;
	}

	public void setPhysicalSubHurt(float PhysicalSubHurt) {
